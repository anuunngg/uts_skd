...
if (isset($_POST['submit'])) {
    ...
    $nim = md5($conn, $_POST['nim']);
    $alamat = mysqli_real_escape_string($conn, $_POST['alamat']);

    mysqli_query($conn, "UPDATE user SET username='$username', nim='$nim', `alamat` = '$alamat' WHERE id=$id");
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <main class="form-signin col-5 m-md-auto text-center">
                    <form method="post">
